"""Simplified Autoformer implemented with PyTorch Lightning."""
...
class _Autoformer(pl.LightningModule):
...
def train(X: np.ndarray, y: np.ndarray, params: dict | None = None) -> dict:
    ...
    model = _Autoformer(X.shape[1], d_model, lr)
